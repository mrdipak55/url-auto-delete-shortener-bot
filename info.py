...
PICS = (environ.get('PICS', 'https://graph.org/file/bcf87b6ffd0b3d39e10b2-a4ba1aa142c23a04a1.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002266549010')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Mrdipak55")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002266549010'))
